Summary:        An URL retrieval utility and library using rustls backend
Name:           curl-rustls
Version:        8.5.0
Release:        1%{?dist}
License:        curl
...
BuildRequires:  rustls-ffi
Requires:       curl-rustls-libs = %{version}-%{release}
Requires:       krb5
Requires:       libssh2
Requires:       openssl
Requires:       rustls-ffi
...
%prep
%setup -q -n curl-8.5.0
tar -xzf %{SOURCE0}
ls /usr/lib/rustls-ffi
...
%configure \
    ...
    --with-rustls=/usr/lib/rustls-ffi \
    --with-gssapi \
    --with-libssh2 \
    --with-nghttp2 \
